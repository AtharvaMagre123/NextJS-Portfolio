    ...
    <div className="flex flex-col items-center justify-center py-20" id="projects">
      ...
      <div className="h-full w-full flex flex-col md:flex-row gap-10 px-10">
        ...
        <ProjectCard
          ...
          github="https://github.com/AtharvaMagre123/UChat"
        />
        ...
        <ProjectCard
          ...
          github="https://github.com/AtharvaMagre123/Autobilling-System"
        />
        ...
        <ProjectCard
          ...
          github="https://github.com/AtharvaMagre123/Infowood"
        />
      </div>
    </div>
  );
